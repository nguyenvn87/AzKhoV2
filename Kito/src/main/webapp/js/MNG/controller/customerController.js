...
//var btnListProductCustomer = Ext.create('MNG.view.popup.BtnCustomerProductAnalys',{});
...
Ext.define('MNG.controller.customerController', {
	...
	btnPdfPrint: function(){
		var location = contextPath + "/customer/danhsachkhachhang.do";
		utilForm.btn_template_popup(location,"Danh sách khách hàng",600,1024,true)
	},
	btnExcelPrint: function(){
		var param = "?FILENAME="+ "Danh_Sach_Khach_Hang"; 
