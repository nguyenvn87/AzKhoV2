...
Ext.define('MNG.controller.srvcServiceController', {
	...
	openBtnUser:function(){
		...
		this.popup = Ext.create('MNG.view.popup.BtnAddSrvcService',{});
	...
	btnExcelPrint:function(){
		var param = "?FILENAME="+ "DanhMucSanPham&IS_SERVICE=1"; 
