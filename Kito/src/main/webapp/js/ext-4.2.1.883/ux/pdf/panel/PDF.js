...
Ext.define('Ext.ux.pdf.panel.PDF',{
    extend: 'Ext.panel.Panel',

    alias: 'widget.pdfpanel',
    
    requires: [
       // 'Ext.pl.upload.FileDownloader'
	],
    ...
    getPagingItems: function(){
        ...
        },
        {
        	...
        	xtype: 'image',
        	itemId: 'pdfDownload',
        	src: contextPath + '/images/fam/disk_multiple.png',
        	autoEl: {
        		tag: 'a',
        		href: me.src,
        		target: '_blank',
    ...
    renderPage: function(num){
        ...
        me.pdfDoc.getPage(num).then(function(page) {
            ...
            var textLayer = me.textLayerDiv ? Ext.create('Ext.ux.pdf.util.PDF.TextLayerBuilder',{
