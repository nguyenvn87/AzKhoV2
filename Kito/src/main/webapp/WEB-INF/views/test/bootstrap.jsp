...
<meta property="og:title" content="Phần mềm quản lý Karaoke online đơn giản, hiệu quả với AZKho.com">
	...
	<section id="main-slider" class="carousel">
		<div class="carousel-inner">
			...
			<div class="item">
				<div class="container">
					<div class="carousel-content">
						<h1>Quản lý bán hàng chuyên nghiệp, hiệu quả</h1>
				...
				<div id="pricing-table" class="row">
					...
					<div class="col-sm-4">
						<ul class="plan featured">
							...
							<li class="plan-price">99.000<sub>th</sub></li>
							<li>1 cửa hàng</li>
							<li>10 người dùng</li>
							<li>1000 mặt hàng</li>
					...
					<div class="col-sm-4">
						<ul class="plan">
							...
							<li class="plan-price">155.000<sub>th</sub></li>
							<li>1 cửa hàng</li>
							<li>Không giới hạn</li>
							<li>Không giới hạn</li>
							<li>Không giới hạn</li>
