...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/lib/ext-4.2.1.883/ext-all.js" charset="utf-8"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/lib/ext-4.2.1.883/src/ux/iframe/IFrame.js" charset="utf-8"></script>
...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/js/lib/ext-4.2.1.883/resources/ext-theme-neptune/ext-theme-neptune-all.css" />
...
var simpleComboBoxStoreUrl = '<c:url value="/code/getComboList.json" />';
	...
	Ext.Loader.setPath({
		...
		'Ext.ux'		: contextPath + '/js/lib/ext-4.2.1.883/ux',
		'BS' 			: contextPath + '/js/container',
		'pckg.cmmn' 	: contextPath + '/js/cmmn',
		'pckg.system'	: contextPath + '/js/system',
		'Ext.custom.common' : contextPath + '/js/lib/ext-4.2.1.883/custom/common'
	}); 
</script>