...
Ext.application({
	...
	controllers : [ 'MNG.controller.quanLyDonXoaController' ],
	launch : function() {
		Ext.create('MNG.view.donXoaView', {
			...
			listeners:{
				afterrender:function(){
					...
					var url = contextPath +'/sale/getDanhSachXoa.json';		
					GridTurn.getStore().getProxy().url = url;
					GridTurn.getStore().currentPage = 1;
					GridTurn.getStore().pageSize=10;
					GridTurn.getStore().load({
