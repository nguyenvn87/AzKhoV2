...
<meta name="description" content="Phần mềm quản lý bán hàng online chuyên nghiệp, hiệu quả với AzKho.com">
<meta name="keywords" content="Phần mềm AzKho, quản lý bán hàng chuyên nghiệp">
...
<meta property="og:title" content="Phần mềm quản lý bán hàng online đơn giản, hiệu quả">
...
<body data-spy="scroll" data-target="#navbar" data-offset="0">
	...
	<section id="main-slider" class="carousel">
		<div class="carousel-inner">
			...
			<div class="item">
				<div class="container">
					<div class="carousel-content">
						<h1>Giúp bạn tăng thu - giảm chi</h1>
							...
							<ul>
								<li class="advantage-item">
									...
									<div class='advantage-content'>
										<h3>Quản lý phòng hát</h3>
										<p class=''>Hiện thị trạng thái các phòng hát. Thời gian
											vào ra, tổng thời gian hát của từng lượt khách. Hiện thị các
											hàng hóa dịch vụ khách đã dùng và cuối cùng là tính tiền, in
											hóa đơn cho khách.</p>
									</div>
								</li>
								<li class="advantage-item">
								...
								<li class="advantage-item">
									...
									<div class='advantage-content'>
										...
										<p class=''>Quản lý kho hàng, nhập kho, xuất kho theo từng
											hóa đơn và đơn vị cung ứng hàng hóa. Hiển thị số lượng hàng
											tồn trong kho</p>
									</div>
								</li>
								<li class="advantage-item">
									...
									<div class='advantage-content'>
										...
										<p class=''>Thống kê doanh thu trong ngày tháng. Báo cáo
											tổng lượng hàng đã bán theo thời gian cụ thể</p>
									</div>
								</li>
							</ul>
						</div>
				...
				<div id="pricing-table" class="row">
					<div class="col-sm-4">
						<ul class="plan">
							...
							<li class="plan-price">0<sub></sub></li>
							<li>1 cửa hàng</li>
							<li>3 người dùng</li>
							<li>100 mặt hàng</li>
							<li>> 10,000 truy vấn/tháng</li>
							<li>Hỗ trợ miễn phí</li>
							<li class="plan-action"><a href="signup.do?ID=QH201"
					...
					<div class="col-sm-4">
						<ul class="plan featured">
							...
							<li class="plan-price">169.000<sub>th</sub></li>
							<li>1 cửa hàng</li>
							<li>10 người dùng</li>
							<li>1000 mặt hàng</li>
					...
					<div class="col-sm-4">
						<ul class="plan">
							...
							<li class="plan-price">225.000<sub>th</sub></li>
							<li>1 cửa hàng</li>
							<li>Không giới hạn</li>
							<li>Không giới hạn</li>
							<li>Không giới hạn</li>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="member">
										...
										<h3>
											Thu Hà<small class="designation">01292.030.668</small>
										</h3>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="member">
										...
										<h3>
											Hương Giang<small class="designation">Tư vấn viên</small>
										</h3>
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="member">
										...
										<h3>
											Khánh Ngọc<small class="designation">Quản lý</small>
										</h3>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="member">
										...
										<h3>
											Nguyễn Nguyên<small class="designation">094.660.8880</small>
										</h3>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="member">
										...
										<h3>
											Lệ Thủy<small class="designation">Hỗ trợ khách hàng</small>
										</h3>
									</div>
								</div>
							</div>
	...
	<footer id="footer">
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
					&copy; 2013 <a target="_blank" href="https://www.facebook.com/Ph%E1%BA%A7n-m%E1%BB%81m-qu%E1%BA%A3n-l%C3%BD-Karaoke-AZKHO-531208190403660/"
						title="Free Twitter Bootstrap WordPress Themes and HTML templates">AzKho.com</a>.
					All Rights Reserved.
				</div>
				<div class="col-sm-6 fb-share-button" data-href="http://azkho.com/banhang.do" 
